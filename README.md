...
You can see there is not "‚ð", but you have to use "‚¤‚§" instead. But this program replace it automatically,
...
Especially, "‚ñ" usually not be given its own note so you will use this feature for it in lots of the cases. But even then, you can still succeeding notes on the same level in many cases. Choose better way for better expressions.
